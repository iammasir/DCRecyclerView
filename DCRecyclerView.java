package com.imi.wonderfultime_family.zhuozhuo.widget;
...
public class DCRecyclerView extends RecyclerView {
    ...
    //********************
    public boolean listenItemsDistance=false;
    ...
    public interface DCListener{
        ...
        void onScrolling(int dx,int dy,int totalX,int totalY);
    ...
    private void getScrollState(int dx, int dy) {
        ...
        totalY+=dy;
        if (listener!=null){
            listener.onScrolling(dx,dy,totalX,totalY);
        }
